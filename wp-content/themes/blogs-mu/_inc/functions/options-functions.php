...
array(
"name" => __("Enable or Disable Featured Image in Blog page template", TEMPLATE_DOMAIN),
"description" => __("you can enable or disable featured image in blog page template", TEMPLATE_DOMAIN),
"id" => $shortname . $shortprefix . "featured_image_blog_page_block",
"inblock" => "extra",
"type" => "select",
"std" => "disable",
"options" => array("disable","enable"))
