...
<?php get_header(); ?>
<?php
    $featured_image_blog_page_block = get_option('tn_blogsmu_featured_image_blog_page_block');
?>
<div id="post-entry">
...
<?php
    if( $featured_image_blog_page_block == 'enable' ){
        if( has_post_thumbnail() ) {
            echo "<div class='blog_post_thumb'>";
            the_post_thumbnail();
            echo '</div>';
        }
    }
